...
class IntegratedDisplayMasking:
    ...
    def process_value(self, 
                     value: str, 
                     column_name: str = "",
                     force_field_type: Optional[FieldType] = None) -> MaskingResult:
        """
        ...
        if force_field_type:
            ...
            identification_result = self.field_identifier.identify_field(
                column_name, [value]
            )
    ...
    def process_dataframe(self, 
                         ...
                         column_field_types: Optional[Dict[str, FieldType]] = None) -> Dict[str, Any]:
        """
...
def mask_for_display(value: str, 
                    show_sensitive: bool = False,
                    column_name: str = "",
                    field_type: Optional[FieldType] = None) -> str:
    """
...
def process_dataframe_for_display(df: pd.DataFrame,
                                show_sensitive: bool = False,
