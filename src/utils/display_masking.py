...
class DisplayMasking:
    ...
    def process_value(self, value: str, field_type: Optional[FieldType] = None, column_name: str = "") -> str:
        ...
        if field_type in [FieldType.NAME, FieldType.EMAIL, FieldType.HKID, 
                         FieldType.PHONE, FieldType.ADDRESS, FieldType.ACCOUNT_ID]:
    ...
    def process_dataframe(self, df, sensitive_columns: Optional[List[str]] = None) -> Dict[str, Any]:
        ...
        return {
            'dataframe': masked_df,
            'masked': True,
            'message': f"Displaying masked data (toggle to show original)"
        }
...
def mask_for_display(value: str, show_sensitive: bool = False, field_type: Optional[FieldType] = None, column_name: str = "") -> str:
    """
