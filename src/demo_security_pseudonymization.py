...
def create_sample_data():
    ...
    return pd.DataFrame({
        ...
        'Customer_Name': ['John Doe', 'Jane Smith', 'Bob Johnson', 'Alice Wong', 'Charlie Brown'],
        'Email': ['john.doe@example.com', 'jane.smith@example.com', 'bob.johnson@example.com', 
                 'alice.wong@example.com', 'charlie.brown@example.com'],
        'HKID': ['A123456(7)', 'B234567(8)', 'C345678(9)', 'D456789(0)', 'E567890(1)'],
        'Phone': ['+852 1234 5678', '+852 2345 6789', '+852 3456 7890', '+852 4567 8901', '+852 5678 9012'],
        'Address': ['123 Main St, Hong Kong', '456 Oak Ave, Kowloon', '789 Pine Rd, New Territories',
                   '321 Elm St, Hong Kong Island', '654 Maple Dr, Tsim Sha Tsui'],
