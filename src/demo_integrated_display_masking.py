...
def print_masking_demo(masker, value, column_name, description=""):
    ...
    print(f"  Would Mask:   {'Yes' if result_masked.confidence >= masker.confidence_threshold else 'No'}")
...
def demo_dataframe_processing():
    ...
    test_df = pd.DataFrame({
        ...
        'email': ['john@example.com', 'jane.smith@test.org', 'xiaoming@gmail.com', 'bob@company.net'],
        ...
        'credit_card': ['1234-5678-9012-3456', '9876-5432-1098-7654', '1111-2222-3333-4444', '5555-6666-7777-8888'],
        ...
        'transaction_date': ['2023-01-15', '2023-02-20', '2023-03-10', '2023-04-05'],  # Non-sensitive
    ...
    for column, metadata in result_masked['masking_metadata'].items():
        print(f"  {column:15}: {metadata['field_type']:12} | Conf: {metadata['confidence']:.2f} | "
