...
class TestDisplayMasking(unittest.TestCase):
    ...
    def test_field_type_identification(self):
        ...
        self.assertEqual(self.masker.identify_field_type("john@example.com"), FieldType.EMAIL)

        # Test name identification
        self.assertEqual(self.masker.identify_field_type("John Doe"), FieldType.NAME)

        # Test HKID identification
        self.assertEqual(self.masker.identify_field_type("A123456(7)"), FieldType.HKID)

        # Test phone identification
        self.assertEqual(self.masker.identify_field_type("+852 2345 6789"), FieldType.PHONE)

        # Test column name context
        self.assertEqual(
            self.masker.identify_field_type("John Doe", "customer_name"), FieldType.NAME
        )
    ...
    def test_email_masking(self):
        ...
        # Standard email
        self.assertEqual(self.masker.mask_email("john@example.com"), "j***@*******.com")

        # Short local part
        self.assertEqual(self.masker.mask_email("a@test.com"), "a@****.com")

        # Complex domain
        self.assertEqual(
            self.masker.mask_email("user@subdomain.example.com"), "u***@*********.example.com"
        )
    ...
    def test_phone_masking(self):
        ...
        self.assertEqual(self.masker.mask_phone("+852 2345 6789"), "+852 ****6789")

        # Without country code
        self.assertEqual(self.masker.mask_phone("2345 6789"), "****6789")

        # Different format
        self.assertEqual(self.masker.mask_phone("23456789"), "****6789")
    ...
    def test_address_masking(self):
        ...
        # With commas
        self.assertEqual(
            self.masker.mask_address("123 Main St, Tsim Sha Tsui, Kowloon"), "*** Kowloon"
        )

        # Without commas
        self.assertEqual(self.masker.mask_address("123 Main Street"), "*** Street")
