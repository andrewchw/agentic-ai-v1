...
class TestIntegratedDisplayMasking:
    ...
    def setup_method(self):
        ...
        self.masker = IntegratedDisplayMasking(
            default_show_sensitive=False, confidence_threshold=0.5
        )
    ...
    def test_initialization(self):
        ...
        assert masker.show_sensitive is False
        ...
        masker = IntegratedDisplayMasking(default_show_sensitive=True, confidence_threshold=0.8)
        assert masker.show_sensitive
        assert masker.confidence_threshold == 0.8

    def test_visibility_control(self):
        """Test visibility toggle functionality"""
        # Initial state
        assert self.masker.show_sensitive is False

        # Set to show sensitive
        self.masker.set_visibility(True)
        assert self.masker.show_sensitive
...
class TestValueProcessing:
    ...
    def test_process_value_low_confidence(self):
        ...
        assert result.is_masked is False  # Should not mask due to low confidence
...
class TestDataFrameProcessing:
        ...
        self.test_df = pd.DataFrame(
            {
                ...
                "address": [
                    ...
                    "Unit 5B, 456 Queen Street, Central",
                    "Suite 3C, 789 King Road, Wan Chai",
                ],
    ...
    def test_dataframe_processing_specific_columns(self):
        ...
        result = self.masker.process_dataframe(
            self.test_df, sensitive_columns=["email", "customer_name"]
        )
    ...
    def test_dataframe_processing_with_forced_types(self):
        ...
        result = self.masker.process_dataframe(self.test_df, column_field_types=column_field_types)
...
class TestHongKongSpecificPatterns:
    ...
    def test_hk_phone_patterns(self):
        ...
        hk_phones = ["+852 1234 5678", "+852-1234-5678", "85212345678", "12345678"]
    ...
    def test_hkid_patterns(self):
        ...
        hkids = ["A123456(7)", "AB123456(8)", "C987654(3)"]
...
class TestErrorHandling:
    ...
    def test_invalid_dataframe_columns(self):
        ...
        result = self.masker.process_dataframe(test_df, sensitive_columns=["nonexistent_column"])
