...
class TestUserInterface:
    ...
    def test_navigation_between_pages(self, page_with_server: Page):
        ...
        nav_selectbox.click()
        page.locator('div[data-testid="stSelectboxVirtualDropdown"]').locator('text="Upload Data"').click()
    ...
    def test_error_handling_graceful(self, page_with_server: Page):
        ...
        for page_name in pages_to_check:
            ...
            for error_indicator in error_indicators:
                assert error_indicator not in page_content, f"Found error indicator '{error_indicator}' on {page_name} page"
