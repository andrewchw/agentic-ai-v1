...
class TestSecurityPseudonymizer:
    ...
    def test_get_anonymization_summary(self):
        ...
        assert summary['reversible'] == False
    ...
    def test_validate_anonymization(self):
        ...
        assert validation['structure_preserved'] == True
        assert validation['columns_preserved'] == True
        assert validation['no_original_pii'] == True
        assert validation['consistent_hashing'] == True
